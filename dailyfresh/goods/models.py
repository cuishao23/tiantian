...
class IndePromotionBanner(BaseModel):
    '''首页促销活动模型类'''
...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type=models.SmallIntegerField(default=1,choices=DISPLAY_TYPE_CHOICES,verbose_name='展示形式')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
